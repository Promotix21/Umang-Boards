...
(function () {
    ...
    const LOCATIONS = [
        ...
        { x: 86.0, y: 62.5,  label: 'Australia',          sub: 'Export Market',       type: 'export' },
        { x: 57.5, y: 33.0,  label: 'Turkey',             sub: 'Export Market',       type: 'export' },
        { x: 69.0, y: 41.5,  label: 'Bangladesh',         sub: 'Export Market',       type: 'export' },
        { x: 67.5, y: 37.5,  label: 'Nepal',              sub: 'Export Market',       type: 'export' },
        { x: 75.5, y: 43.0,  label: 'Vietnam',            sub: 'Export Market',       type: 'export' },
        { x: 76.0, y: 40.0,  label: 'Philippines',        sub: 'Export Market',       type: 'export' },
        { x: 55.5, y: 50.0,  label: 'Tanzania',           sub: 'Export Market',       type: 'export' },
        { x: 48.0, y: 42.0,  label: 'Algeria',            sub: 'Export Market',       type: 'export' },
    ];
